...
AdvantagesPage.getLayout = (page: React.ReactElement) => <DashboardLayout {...page.props}> {page} </DashboardLayout>;
...
export default function AdvantagesPage(props: AdvantagesPageProps) {
  return <div>{ERoutes.ADVANTAGES}</div>;
}
